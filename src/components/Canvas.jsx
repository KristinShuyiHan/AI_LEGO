...
const Canvas = () => {
  ...
  return (
    ...
    <div className="flex flex-row w-full h-full">
      ...
      <div className="flex flex-col left-[1%] bottom-[1%] absolute">
        <p className="font-bold text-lg">Templates:</p>
        <button
          onClick={() => addTemplate("empty")}
          className="bg-red-400 rounded-lg p-1 my-2"
        >
          Clear
        </button>
        <button
          onClick={() => addTemplate("8-stage")}
          className="bg-cardet-gray rounded-lg p-1 my-2"
        >
          8 Stages
        </button>
        <button
          onClick={() => addTemplate("6-stage")}
          className="bg-sage rounded-lg p-1 my-2"
        >
          6 Stages
        </button>
        <button
          onClick={() => addTemplate("3-stage")}
          className="bg-citron rounded-lg p-1 my-2"
        >
          3 Stages
        </button>
        <br></br>
        ...
        <button
          ...
          className="bg-problem rounded-lg p-1 my-2"
        >
          Problem
        </button>
        <button
          onClick={() => addCardData("task")}
          className="bg-task rounded-lg p-1 my-2"
        >
          Task
        </button>
        <button
          onClick={() => addCardData("data")}
          className="bg-data rounded-lg p-1 my-2"
        >
          Data
        </button>
        <button
          onClick={() => addCardData("model")}
          className="bg-model rounded-lg p-1 my-2"
        >
          Model
        </button>
        <button
          onClick={() => addCardData("train")}
          className="bg-train rounded-lg p-1 my-2"
        >
          Train
        </button>
        <button
          onClick={() => addCardData("test")}
          className="bg-test rounded-lg p-1 my-2"
        >
          Test
        </button>
        <button
          onClick={() => addCardData("deploy")}
          className="bg-deploy rounded-lg p-1 my-2"
        >
          Deploy
        </button>
        <button
          onClick={() => addCardData("feedback")}
          className="bg-feedback rounded-lg p-1 my-2"
        >
          Feedback
        </button>
      </div>
